...
public class ResultsTable {
  ...
  public void start() {
    ...
    currentFrame.setTitle("Result table");
    currentFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
    currentFrame.setSize(new Dimension(1500, 500));
    currentFrame.setLocation(300, 350);
    String[] columnNames = {"Customer Id","Order count", "reject %", "program T_avg",
      "waiting T_avg", "Service T_avg", "Dispersion T_wait", "Dispersion Т_service", "Device", "Device efficiency "};
