...
public class StepMode {
  ...
  public void start() {
    ...
    currentFrame.setTitle("Step mode");
  ...
  // bufferTableData[0][1] = "";
    ...
    String[] calendarTableColumnNames = {"Time", "Info", "Order state", "Order ID", "Completed", "Rejected"};
    ...
    buttonAuto.setText("Result table");
    buttonAuto.setForeground(Color.GRAY);
    currentFrame.getContentPane().add(buttonAuto).setBounds(1000,750,220,30);

    currentFrame.getContentPane().add(new JScrollPane(waveform.getJPanel()))
            .setBounds(820, 20, 690, 500);

    JLabel bufferLbl = new JLabel("Buffer");
    ...
    JLabel deviceLbl = new JLabel("Devices");
    ...
    JLabel cancelLbl = new JLabel("Reject");
    ...
    JLabel infoLbl = new JLabel("Operation history");
